...
class CrosswordCreator():
    ...
    def enforce_node_consistency(self):
        ...
        """
        for var in self.crossword.variables:
            # iterate over a copy of the domain set because we cant
            # mutate a set while iterating over the original
    ...
    def revise(self, x, y):
        ...
        for x_word in self.domains[x].copy():
            # check if there is a corresponding y_word in the domain of y
    ...
    def select_unassigned_variable(self, assignment):
        ...
        return values.
        """
        # every variable not yet in the assignment is a candidate
        unassigned = [
